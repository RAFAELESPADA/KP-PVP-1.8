...
/*    */ 
/*    */ public class Leopard implements org.bukkit.command.CommandExecutor
/*    */ {
/*    */   private Main main;
/*    */   static Main plugin;
/*    */   
/*    */   public Leopard(Main main)
/*    */   {
/* 20 */     this.main = main;
/* 21 */     plugin = main;
/*    */   }
...
/*    */     
/* 29 */     if (cmd.getName().equalsIgnoreCase("kleopard"))
/*    */     {
/*    */ 
/*    */ 
/*    */ 
...
/* 37 */         return true;
/*    */       }
if (Main.kits.getBoolean("LeopardDisabled")) {
	p.sendMessage(API.NomeServer + ChatColor.RED + "The Leopard kit is disabled, sorry");
	return true;
}
...
/*    */       
/*    */ 
/* 67 */       Habilidade.setAbility(p, "Leopard");
/* 68 */       p.sendMessage(String.valueOf(this.main.getConfig().getString("Prefix").replace("&", "§")) + this.main.getConfig().getString("Message.Kit").replaceAll("%kit%", "Leopard").replace("&", "§"));
/*    */       
...
/* 77 */         me.RafaelAulerDeMeloAraujo.TitleAPI.TitleAPI.sendTitle(p, Integer.valueOf(20), Integer.valueOf(60), Integer.valueOf(20), this.main.getConfig().getString("Title.KitTitle"), this.main.getConfig().getString("Title.KitSubTitle").replaceAll("%kit%", "Leopard"));
/*    */       }
/*    */     
/*    */     
/*    */ 

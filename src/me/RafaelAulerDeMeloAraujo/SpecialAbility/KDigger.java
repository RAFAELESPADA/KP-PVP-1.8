...
/*    */ 
/*    */ public class KDigger implements org.bukkit.command.CommandExecutor
/*    */ {
/*    */   private Main main;
/*    */   static Main plugin;
/*    */   
/*    */   public KDigger(Main main)
/*    */   {
/* 20 */     this.main = main;
/* 21 */     plugin = main;
/*    */   }
...
/*    */     
/* 29 */     if (cmd.getName().equalsIgnoreCase("kdigger"))
/*    */     {
/*    */ 
/*    */ 
/*    */ 
...
/* 37 */         return true;
/*    */       }
if (Main.kits.getBoolean("DiggerDisabled")) {
	p.sendMessage(API.NomeServer + ChatColor.RED + "The Digger kit is disabled, sorry");
	return true;
}
...
/*    */       
/*    */ 
/* 67 */       Habilidade.setAbility(p, "Digger");
/* 68 */       p.sendMessage(String.valueOf(this.main.getConfig().getString("Prefix").replace("&", "§")) + this.main.getConfig().getString("Message.Kit").replaceAll("%kit%", "Digger").replace("&", "§"));
/*    */       
...
ItemStack especial = new ItemStack(Material.DIRT);
/* 61 */       ItemMeta especial2 = especial.getItemMeta();
/* 62 */       especial2.setDisplayName("§aDigger");
...
/* 77 */         me.RafaelAulerDeMeloAraujo.TitleAPI.TitleAPI.sendTitle(p, Integer.valueOf(20), Integer.valueOf(60), Integer.valueOf(20), this.main.getConfig().getString("Title.KitTitle"), this.main.getConfig().getString("Title.KitSubTitle").replaceAll("%kit%", "Digger"));
